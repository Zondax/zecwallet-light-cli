...
impl<P: Parameters + Send + Sync + 'static> Keystores<P> {
    ...
    pub async fn read<R: io::Read>(
        ...
        match variant {
            ...
            #[cfg(feature = "ledger-support")]
            1 => {
                LedgerKeystore::read(reader, config)
                    .await
                    .map(Into::into)
            },
...
impl<'ks, P: Parameters + Send + Sync + 'static> Builder for Builders<'ks, P> {
    ...
    fn add_sapling_spend(
        ...
        match self {
            Self::Memory(this) => {
                this.add_sapling_spend(key, diversifier, note, merkle_path)
                    .map(|_| ())?
            },
            #[cfg(feature = "ledger-support")]
            Self::Ledger(this) => {
    ...
    fn add_sapling_output(
        ...
        match self {
            Self::Memory(this) => {
                this.add_sapling_output(ovk, to, value, memo)
                    .map(|_| ())?
            },
            #[cfg(feature = "ledger-support")]
            Self::Ledger(this) => {
    ...
    fn add_transparent_input(
        ...
        match self {
            Self::Memory(this) => {
                this.add_transparent_input(key, utxo, coin)
                    .map(|_| ())?
            },
            #[cfg(feature = "ledger-support")]
            Self::Ledger(this) => {
    ...
    fn add_transparent_output(
        ...
        match self {
            Self::Memory(this) => {
                this.add_transparent_output(to, value)
                    .map(|_| ())?
            },
            #[cfg(feature = "ledger-support")]
            Self::Ledger(this) => {
    ...
    async fn build(
        ...
        match self {
            Self::Memory(this) => {
                this.build(consensus, prover, fee)
                    .await
                    .map_err(Into::into)
            },
            #[cfg(feature = "ledger-support")]
